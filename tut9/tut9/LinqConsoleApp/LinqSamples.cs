...
namespace LinqConsoleApp
{
    public class LinqSamples
    {
        ...
        */
        ...
        public void Task6()
        {
            var res = Emps.Join(Depts, e => e.Deptno, d => d.Deptno, (e, d) => new { Emps = e, Depts = d }); 
        }
        ...
        public void Task7()
        {
            var res = Emps.GroupBy(e=> e.Job).Select(e=> new { EmployeeJob = e.Key, EmployeeNumber = e.Count()});
        }
